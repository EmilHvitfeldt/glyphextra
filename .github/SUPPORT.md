# Getting help with glyphextra

Thanks for using glyphextra. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/glyphextra/issues) to make sure the 
